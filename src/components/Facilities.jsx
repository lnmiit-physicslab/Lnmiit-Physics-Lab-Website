...
function Facilities() {
	return (
		<div className=" min-h-screen">
			<div className="glow-on-hover md:w-[56%] md:h-[5%] ml-5 textify grad mt-5 mr-5 mb-5 rounded-2xl  border-2 bg-gray-50/100 p-[2rem] text-2xl shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)] md:ml-[22%] md:mr-[22%]">
