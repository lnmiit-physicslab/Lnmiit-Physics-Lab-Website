...
function Facilities() {
	return (
		...
		<div className=" min-h-screen">
			...
			<p className="  ml-5  mr-5 md:ml-[22%] md:mr-[22%]  rounded-2xl border-2 bg-gray-50/50 p-[2rem] text-2xl shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]">
			...
			<p className="ml-5  mr-5 md:ml-[22%] md:mr-[22%]  mb-20 mt-5 rounded-2xl border-2 bg-gray-50/50 p-[2rem] text-xl shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]">
				{ComputationalReaserchFacility_BriefDescreption.Hardware}
			</p>
			<h2 className="ml-40 text-left text-2xl underline ">Software : </h2>
			<p className="ml-5  mr-5 md:ml-[22%] md:mr-[22%]  mt-5 rounded-2xl border-2 bg-gray-50/50 p-[2rem] text-xl shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]">
				{ComputationalReaserchFacility_BriefDescreption.Software}
			</p>
			<h1 className=" mt-16 mb-14 text-5xl">EXPERIMENTAL FACILITY</h1>
			<p className=" ml-5  mr-5 md:ml-[22%] md:mr-[22%]  mb-5 rounded-2xl border-2 bg-gray-50/50 p-[2rem] text-2xl shadow-[0px_4px_16px_rgba(17,17,26,0.1),_0px_8px_24px_rgba(17,17,26,0.1),_0px_16px_56px_rgba(17,17,26,0.1)]">
				{ExperimentalFacilityText}
			</p>
			<div className="mb-20 mt-10 flex flex-wrap justify-around ">
				<div className="flex md:w-1/4 w-[350px] flex-col items-center justify-center pb-5 ">
					<img
