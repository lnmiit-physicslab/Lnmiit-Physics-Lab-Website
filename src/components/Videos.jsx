...
function Videos() {
	return (
		<div className="main-wrapper">
			<div className="section1-wrapper m-3 md:m-10 rounded-3xl border-2 shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px]  bg-gray-50/75">
				{/* section-1  */}
				...
				<div className="flex flex-wrap items-center justify-center gap-10 pt-10">
					{YtLinks.filter((vid) => {
						...
						<div className="mb-10 border-2 shadow-[-10px_-10px_30px_4px_rgba(0,0,0,0.1),_10px_10px_30px_4px_rgba(45,78,255,0.15)] ">
							<div
								key={vid.id}
								className="md:w-[420px] w-[100%] flex-col items-center justify-center "
							>
								<iframe
									className=" rounded-lg flex items-center h-[350px] w-[100%]"
