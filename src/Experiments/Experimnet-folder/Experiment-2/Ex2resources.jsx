	...
	return (
		<div className="tab-content  m-10 mt-10   flex flex-col rounded-3xl  border-2 bg-gray-50/100 pl-10 pt-10  shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px]">
			...
			<div className="flex min-h-full flex-col content-evenly items-start pt-5">
				...
				<a target="_blank" href="https://en.wikipedia.org/wiki/Pendulum">
					2. https://en.wikipedia.org/wiki/Pendulum
				</a>
				<a
					target="_blank"
					href="https://www.coursehero.com/file/6572503/Physics-II-Lab-w-answers-Part-5/"
				>
					3. https://www.coursehero.com › FSU › PHY › PHY 2053
				</a>
				<a
					target="_blank"
					href="http://epsassets.manchester.ac.uk/structural-concepts/"
				>
					4. Xue, Linwei (2007). "Pendulum Systems". Seeing and Touching
					Structural Concepts. Civil Engineering Dept., Univ. of Manchester, UK.
					Retrieved 2008-12-10.
				</a>
				<a
					target="_blank"
					href="http://hyperphysics.phy-astr.gsu.edu/hbase/pend.html"
				>
					5. Nave, Carl R. (2006). "Simple pendulum". Hyperphysics. Georgia
					State Univ. Retrieved 2008-12-10.
				</a>
				<a
					target="_blank"
