...
export default function Ex6video() {
	return (
		<div className="flex flex-col justify-evenly tab-content m-10 mt-10 flex min-h-screen flex-col justify-evenly rounded-3xl border-2 bg-gray-50/75 pt-10  shadow-[rgba(0,_0,_0,_0.4)_0px_30px_90px]">
			<h3>VIDEO</h3>
				<p align="center">
					<iframe
						width="500vw"
