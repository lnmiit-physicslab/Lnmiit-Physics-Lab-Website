...
export default function Ex5resources() {
	return (
			...
			<div id="menu3" className="tab-pane fade">
				...
				<p>
					<b>
						1.{" "}
						<a
							href="https://en.wikipedia.org/wiki/Spectrometer"
							target="_blank"
						>
							Spectrometer
						</a>
						...
						2.{" "}
						<a
							href="https://en.wikipedia.org/wiki/Minimum_deviation"
							target="_blank"
						>
							Minimum deviation
						</a>
						...
						3. Mark A. Peterson.{" "}
						<a
							href="http://www.mtholyoke.edu/~mpeterso/classes/phys103/geomopti/MinDev.html"
							target="_blank"
						>
